...
<head>
    <!-- Title -->
    <title>Alt-Tree | Delete Product</title>
    ...
    <main id="content">
        ...
        <div class="container space-1 space-1--lg">
            ...
            <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                <h1 class="font-weight-bold">Delete Product</h1>
                <p>Press Delete on the products you would like to permanently remove.</p>
            </div>
            <!-- End Title -->
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <div class="col-sm-6 col-lg-3 mb-5">
                            <!-- Shop Item -->
                            <a class="d-block border text-dark text-center" href="editProduct.php?id=<?= $row["id"] ?>">
                                ...
                                <div class="border-top p-4">
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <span class="d-block mb-0"><button class="btn btn-danger" type="submit" name="delete_product">Delete</button></span>
                                    </form>
                                </div>
                            </a>
                        </div>
