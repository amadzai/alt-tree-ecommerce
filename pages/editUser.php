...
$id = $_GET['id'];
$sql = "SELECT * FROM alt_tree_user WHERE id='$id' LIMIT 1";
...
<head>
    <!-- Title -->
    <title>Alt-Tree | Edit User</title>
...
<body>
    ...
    <main id="content">
        ...
        <!-- End Hero Section -->
        <a href="editUserStatus.php"><img src="../assets/img/icons/left-arrow.png" class="float-left ml-4 mt-4"></a>
        ...
        <div class="container space-2 space-2--lg">
            <form action="editUser.php" class="js-validate row" method="post">
                        ...
                        <div class="col-10">
                            ...
                            <div class="js-form-message">
                                <div class="js-focus-state input-group input-group form">
                                    <img src="<?php echo (isset($userAlt['pictureSource']) && !empty($userAlt['pictureSource'])) ? "../assets/img/user/" . $userAlt['pictureSource'] : "../assets/img/user/blank-avatar.png" ?>" alt="A picture of a blank avatar" class="img-fluid">
                                    <div class="">
                ...
                <div class="col-lg-5">
                    ...
                    <!-- Content -->
                    <h6>Username (Required)</h6>
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="username" placeholder="Enter Username" aria-label="Enter Product Name" required value="<?php echo isset($userAlt['username']) && !empty($userAlt['username']) ? $userAlt['username'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="email" class="form-control form__input" name="email" placeholder="Enter Email" aria-label="Enter Product Name" required value="<?php echo isset($userAlt['email']) && !empty($userAlt['email']) ? $userAlt['email'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="first_name" placeholder="Enter First Name" aria-label="Enter Product Name" value="<?php echo isset($userAlt['first_name']) && !empty($userAlt['first_name']) ? $userAlt['first_name'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="last_name" placeholder="Enter Last Name" aria-label="Enter Product Name" value="<?php echo isset($userAlt['last_name']) && !empty($userAlt['last_name']) ? $userAlt['last_name'] : "" ?>">
                        </div>
                    </div>

                    <h6>User Type (Required)</h6>
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="user_type" placeholder="Enter User Type" aria-label="Enter Product Name" required value="<?php echo isset($userAlt['user_type']) && !empty($userAlt['user_type']) ? $userAlt['user_type'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="phone_number" placeholder="Enter Phone Number" aria-label="Enter Product Name" value="<?php echo isset($userAlt['phone_number']) && !empty($userAlt['phone_number']) ? $userAlt['phone_number'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="address" placeholder="Enter Address" aria-label="Enter Product Name" required value="<?php echo isset($userAlt['address']) && !empty($userAlt['address']) ? $userAlt['address'] : "" ?>">
                        </div>
                    </div>
                    ...
                    <div style="visibility:hidden;">
                        <input type="number" min="0" class="form-control form__input" name="id" placeholder="Enter Product Stock" aria-label="product stock" required value="<?php echo isset($userAlt['id']) && !empty($userAlt['id']) ? $userAlt['id'] : "" ?>">
                    </div>
