...
<head>
    <!-- Title -->
    <title>Alt-Tree | Add Product</title>
...
<body>
    ...
    <main id="content">
        ...
        <div class="container space-2 space-2--lg">
            <form action="addProduct.php" class="js-validate row" method="post">
                        ...
                        <div class="col-10">
                            ...
                            <div class="js-form-message">
                                <div class="js-focus-state input-group input-group form">
                                    <img src="../assets/img/icons/add-image.png" alt="A plus icon on top of an image" class="img-fluid">
                                    <div class="">
                                        <input class="form-control" type="file" id="pictureSource" name="pictureSource" required>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="name" placeholder="Enter Product Name" aria-label="Enter Product Name" required>
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="number" min="0" class="form-control form__input" name="price" placeholder="Enter Product Price (RM)" aria-label="product price" required>
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="text" class="form-control form__input" name="description" placeholder="Enter Product Description" aria-label="Enter Product Description" required>
                        </div>
                    </div>
                    ...
                    <div class="js-form-message">
                        <div class="js-focus-state input-group input-group form">
                            <input type="number" min="0" class="form-control form__input" name="stock" placeholder="Enter Product Stock" aria-label="product stock" required>
                        </div>
                    </div>

                    <div class="mt-4">
                        <button class="btn btn-primary" name="save_btn"><a class="text-white">Save Product</a></button>
                    </div>
                </div>
            </form>
        </div>
