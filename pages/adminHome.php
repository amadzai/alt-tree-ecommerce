...
<head>
    <!-- Title -->
    <title>Alt-Tree | Admin Home</title>
        ...
        <div class="bg-gray-100">
            <div class="container space-1 space-1--lg">
                ...
                <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                    <span class="u-label u-label--sm u-label--purple mb-3">Admin Features</span>
                    <h2 class="h3">A quick access menu for all admin functionalities.</h2>
                </div>
                <!-- End Title -->
                ...
                <div class="card-deck d-block d-lg-flex card-lg-gutters-2">
                    <div class="card border-0 mb-3">
                        ...
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="addProduct.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/add.png" alt="An add icon for products">
                                <h4 class="h5 mb-1">Add Product</h4>
                                <p class="mb-0">Add new products and their details into the product list.</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
                    ...
                    <div class="card border-0 mb-3">
                        <!-- Works -->
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="editProductSelect.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/edit.png" alt="An edit icon for products">
                                <h4 class="h5 mb-1">Edit Product</h4>
                                <p class="mb-0">Edit existing product's details.</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
                    ...
                    <div class="card border-0 mb-3">
                        ...
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="deleteProduct.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/delete.png" alt="A delete icon for products">
                                <h4 class="h5 mb-1">Delete Product</h4>
                                <p class="mb-0">Delete existing product from the product list.</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
                ...
                <div class="card-deck d-block d-lg-flex card-lg-gutters-1">
                    <div class="card border-0 mb-3 mb-lg-0">
                        ...
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="createAdmin.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/add-user.png" alt="An add icon for users">
                                <h4 class="h5 mb-1">Create an Admin</h4>
                                <p class="mb-0">Create a new admin account with their details.</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
                    ...
                    <div class="card border-0 mb-3 mb-lg-0">
                        <!-- Works -->
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="editUserStatus.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/delete-user.png" alt="An edit icon for users">
                                <h4 class="h5 mb-1">Edit User Status</h4>
                                <p class="mb-0">Edit the status of all users (customer, admin).</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body border border-bottom-0 rounded-top text-center p-5">
                            <a href="adminShop.php">
                                <img class="u-md-avatar rounded mb-4" src="../assets/img/icons/focus.png" alt="A view icon for the shop">
                                <h4 class="h5 mb-1">View Shop</h4>
                                <p class="mb-0">View the shop list and the products as an admin.</p>
                            </a>
                        </div>
                        <!-- End Works -->
                    </div>
        ...
        <div class="container space-2">
            <div class="row justify-content-md-between">
                ...
                <div class="col-lg-4 order-lg-1 d-flex align-items-start flex-column">
                    <!-- Logo -->
                    <a class="d-inline-block my-6" href="#" aria-label="Space">
