        ...
        <div class="container space-2 space-3--lg">
            <div class="row">
                ...
                <div class="col-lg-5">
                    ...
                    <input type="number" min="0" class="form-control form__input" name="quantity" placeholder="Quantity" aria-label="Search Space">

                    <!-- End Color Select -->

                    <hr class="my-4">

                    <a class="btn btn-block btn-secondary" href="#">Admin</a>
                    <!-- End Content -->
                </div>
            </div>
        </div>
