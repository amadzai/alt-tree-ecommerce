            ...
            <div class="container space-2 space-2--lg">
                <form action="" class="js-validate row">
                            ...
                            <div class="col-10">
                                ...
                                <div class="js-form-message">
                                    <div class="js-focus-state input-group input-group form">
                                        <img src="<?php echo (isset($pictureSource) && !empty($pictureSource)) ? "../assets/img/user/" . $pictureSource : "../assets/img/user/blank-avatar.png" ?>" alt="A picture of a blank avatar" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="mt-4">
                            <button class="btn btn-primary" name="edit_btn"><a class="text-white" href="profile.php?edit_profile=true">Edit Profile</a></button>
                        </div>
                    </div>
                </form>
            </div>
