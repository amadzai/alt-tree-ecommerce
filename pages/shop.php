            ...
            <div id="logoAndNav" class="container-fluid">
                ...
                <nav class="js-mega-menu navbar navbar-expand-lg u-header__navbar">
                    ...
                    <div class="u-header__navbar-brand-wrapper">
                        <a class="navbar-brand u-header__navbar-brand" href="home.php" aria-label="Alt-Tree">
                        ...
                        <ul class="navbar-nav u-header__navbar-nav">
                            <?php if (isset($_SESSION['user'])) : ?>
                                ...
                                <li class="nav-item u-header__sub-menu-list-item dropdown-item">
                                    <a id="homeMegaMenu" class="nav-link u-header__nav-link " href="shop.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="shopSubMenu">
                                        Shop
                                    </a>
                                <li class="nav-item u-header__sub-menu-list-item dropdown-item ">
                                    <a id="homeMegaMenu" class="nav-link u-header__nav-link " href="profile.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="homeSubMenu">
                                        Profile
                                    </a>
                                <li class="nav-item u-header__sub-menu-list-item dropdown-item ">
                    ...
                    <ul class="navbar-nav flex-row u-header__secondary-nav">
                        <?php if (isset($_SESSION['user'])) : ?>
                            ...
                            <li class="nav-item u-header__navbar-icon-wrapper u-header__navbar-icon">
                                <a id="shoppingCartDropdownInvoker" class="btn btn-xs btn-icon btn-text-dark" href="#">
    ...
    <main id="content">
        ...
        <div class="container space-1 space-1--lg">
            ...
            <div class="w-md-80 w-lg-60 text-center mx-md-auto mb-9">
                <span class="u-label u-label--sm u-label--purple mb-3">Alt-Tree Products</span>
                <h2 class="h3">Recycled and refurbished products by Alt-Tree</h2>
                <p>Blending recycled and refurbished items with biodegradable materials for a sustainable shopping experience.</p>
            </div>
            <!-- End Title -->

            <div class="row mb-9">
                <?php $sql = "SELECT * FROM alt_tree_product";
                $result = mysqli_query($db, $sql);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <div class="col-sm-6 col-lg-3 mb-5">
                            <!-- Shop Item -->
                            <a class="d-block border text-dark text-center" href="product.php?id=<?= $row["id"] ?>">
                                <img class="img-fluid" src="<?php echo (isset($row['pictureSource']) && !empty($row['pictureSource'])) ? "../assets/img/product/" . $row['pictureSource'] : "../assets/img/logos/Logo.png" ?>" alt="The logo of Alt-Tree">
                                <div class="border-top p-4">
                                    <h2 class="h5"><?= $row["name"] ?></h2>
                                    <span class="d-block h5 text-primary mb-0">RM <?= $row["price"] ?></span>
                                </div>
                            </a>
                        </div>
                <?php
        ...
        <div class="gradient-half-primary-v1">
            <div class="bg-img-hero" style="background-image: url(../assets/img/background/Bg2.png);">
                <div class="container">
                    <div class="row justify-content-lg-center align-items-md-center text-center space-1">
                        <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                            <img class="img-fluid" src="../assets/img/product/biobag.png" alt="A picture of a biodegradeable bag">
                        </div>
        ...
        <div class="container space-2">
            <div class="row justify-content-md-between">
                ...
                <div class="col-lg-4 order-lg-1 d-flex align-items-start flex-column">
                    <!-- Logo -->
                    <a class="d-inline-block my-6" href="home.php" aria-label="Space">
