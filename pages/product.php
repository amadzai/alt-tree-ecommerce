            ...
            <div class="container space-2 space-3--lg">
                <div class="row">
                            ...
                            <div class="col-10">
                                <div class="js-slick-carousel u-slick">
                                    <div class="js-slide">
                                        ...
                                        <input class="form-control" type="file" id="pictureSource" name="pictureSource" style="visibility:hidden">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5">
                        ...
                        <h2 class="h6">Quantity:</h2>
                        <input type="number" min="1" class="form-control form__input" name="quantity" placeholder="Quantity" aria-label="Search Space" value="1">

                        <hr class="my-4">

                        <?php if ($product["stock"] > 0) : ?>
                            <a class="btn btn-block btn-primary" name="cart_btn">Add to Cart</a>
                            <input type="text" class="form-control form__input" name="name" placeholder="Enter Product Name" aria-label="Enter Product Name" value="<?php echo isset($product['name']) && !empty($product['name']) ? $product['name'] : "" ?>" style="visibility:hidden">
                            <input type="number" class="form-control form__input" name="price" placeholder="Enter Product Name" aria-label="Enter Product Name" value="<?php echo isset($product['price']) && !empty($product['price']) ? $product['price'] : "" ?>" style="visibility:hidden">
                        <?php
                        else : ?>
                            <a class="btn btn-block btn-secondary">Unavailable</a>
                        <?php
                        endif;
                        ?>
                        <!-- End Content -->
